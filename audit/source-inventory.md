...
- `src/syscall/dispatcher_generated.c`: generated by `scripts/gen_dispatcher.py --generate`; ignored by git; present locally.
...
- The Makefile has a dependency to generate it, but clean-checkout and CI freshness behavior should be covered by task 03 before broad refactors.
