/*
 * file_io.c — Test file I/O (CreateFileA, WriteFile, ReadFile, CloseHandle, DeleteFileA)
 *
 * Build: make samples SAMPLE=file_io
 * Run:   ./my_wine samples/file_io/file_io.exe
 */
...
int main(void)
{
    ...
    n += fmt_hex64(buf + n, (uint64_t)hFile);
