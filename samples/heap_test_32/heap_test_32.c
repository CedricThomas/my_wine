/*
 * heap_test_32.c — Test heap management (PE32)
 *
 * Build: make samples SAMPLE=heap_test_32
 * Run:   ./my_wine samples/heap_test_32/heap_test_32.exe
 */
...
int main(void)
{
    ...
    n += fmt_hex32(buf + n, (uint32_t)heap);
    ...
    n += fmt_hex32(buf + n, (uint32_t)reptr);
