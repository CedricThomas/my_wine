...
| PE32 runtime entry | Shared PE parsing/loader pieces that compile under `MY_WINE32`, PE32 process helpers, PE32 syscall primitives, PE32 heap backend, guest-facing stubs. | PE32+-only entry/trampoline code, musl oldmalloc backend, 64-bit-only ABI assumptions. |
...
| PE32-only | `src/loader/pe32_entry.c`, `src/loader/pe32_process.c`, `src/loader/pe32_process.h`, `src/loader/pe32_run_guest.S`, `src/syscall/clone.S`, `src/syscall/mmap2_asm.S`, `src/heap/musl_malloc_32_compat.c`, PE32 samples. |
