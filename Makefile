...
$(foreach f,rb_audio.o rb_event.o rb_init.o rb_input.o rb_palette.o rb_surface.o rb_surface_present.o rb_window.o,$(eval CFLAGS_backend/sdl2/$(f) = $(SPECIAL_CFLAGS) $(SDL2_CFLAGS)))
